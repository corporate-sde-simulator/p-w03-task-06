...
> **Welcome to Product-Track Week 3, Task 6!**
...
| `src/migrationEngine.py` | Main source code - **has bugs to fix** |
| `src/rollbackManager.py` | Supporting code - **may also have bugs** |
...
### Bug #1 - in `src/migrationEngine.py` (around line 13)
**What's wrong:** - see PR comments."""

**How to find it:** Open `src/migrationEngine.py` and look for the `BUG:` comment near line 13. Read the comment carefully - it describes exactly what's broken.
...
### Bug #2 - in `src/migrationEngine.py` (around line 17)
**What's wrong:** described in TICKET.md

**How to find it:** Open `src/migrationEngine.py` and look for the `BUG:` comment near line 17. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #3 - in `src/migrationEngine.py` (around line 22)
**What's wrong:** in logic."""

**How to find it:** Open `src/migrationEngine.py` and look for the `BUG:` comment near line 22. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #4 - in `src/rollbackManager.py` (around line 13)
**What's wrong:** - see PR comments."""

**How to find it:** Open `src/rollbackManager.py` and look for the `BUG:` comment near line 13. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #5 - in `src/rollbackManager.py` (around line 17)
**What's wrong:** described in TICKET.md

**How to find it:** Open `src/rollbackManager.py` and look for the `BUG:` comment near line 17. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #6 - in `src/rollbackManager.py` (around line 22)
**What's wrong:** in logic."""

**How to find it:** Open `src/rollbackManager.py` and look for the `BUG:` comment near line 22. Read the comment carefully - it describes exactly what's broken.
