# Architecture Decision Record - Database migration rollback engine
...
Implement Database migration rollback engine using industry-standard patterns appropriate for python and our platform requirements.
